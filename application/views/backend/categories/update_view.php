									...
									<div class="card-body">
										<div class="row">
											<div class="col-sm-8 mx-auto">
												<form action="<?= base_url("kelola-kategori/update/" . $category["category_id"]) ?>" method="post">
													<div class="form-group row">
														<input type="hidden" name="category_id" value="<?= $category["category_id"] ?>">
														<label for="name" class="col-sm-2 col-form-label">Nama Kategori</label>
														<div class="col-sm-10">
															<input type="text" class="form-control <?= form_error('name') ? 'is-invalid' : ''; ?>" name="name" id="name" value="<?= $category["name"] ?>">
