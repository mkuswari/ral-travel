									...
									<div class="card-body">
										<div class="row">
											<div class="col-sm-8 mx-auto">
												<form action="<?= base_url("kelola-wisata/tambah") ?>" method="post" enctype="multipart/form-data">
													...
													<div class="form-group row">
														...
														<div class="col-sm-10">
															<input type="text" class="form-control <?= form_error('location') ? 'is-invalid' : '' ?>" name="location" id="location">
													...
													<div class="form-group row">
														...
														<div class="col-sm-10">
															<input type="number" class="form-control <?= form_error('price') ? 'is-invalid' : '' ?>" name="price" id="price">
